...
public class FileSystemCrawler {
	private static Queue<File> sharedQueue = new ConcurrentLinkedQueue<>();
    ...
    public static void main(String [] args) {
		...
		Thread thread1 = new Thread(() -> {
            ...
            sharedQueue.addAll(fileCrawler1.getFiles());
		...
		Thread thread2 = new Thread(() -> {
            ...
            sharedQueue.addAll(fileCrawler2.getFiles());
            terminateFlag.set(true);
		});
		...
		Thread thread3 = new Thread(() -> {
	        ...
	        sharedQueue.addAll(fileCrawler3.getFiles());
	        terminateFlag.set(true);
		});
		...
		try {
			...
			List<File> allFiles;
			 synchronized (FileSystemCrawler.class) {
	                allFiles = new ArrayList<>(sharedQueue);
	            }
